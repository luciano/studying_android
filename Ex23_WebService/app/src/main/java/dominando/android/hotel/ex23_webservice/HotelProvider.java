...
public class HotelProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "dominando.android.hotel.ex23_webservice";
    ...
    public String getType(Uri uri) {
        return null; // nao implementamos busca por MimeType
    }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            ...
            case TIPO_HOTEL_ESPECIFICO:
                String id = uri.getLastPathSegment();
                linhasAfetadas = sqlDB.update(HotelSQLHelper.TABELA_HOTEL,
                        values, HotelSQLHelper.COLUNA_ID + "= ?", new String[]{id});
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
