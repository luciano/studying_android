...
public class MainExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            int left = mViewHolder.mTextView.getPaddingLeft();
            mViewHolder.mTextView.setPadding(left, 20, 10, 20);
            mViewHolder.mTextView.setBackgroundColor(parent.getContext().getResources().getColor(R.color.expandableGroup));
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mViewHolder.mTextView.setPadding(mViewHolder.mTextView.getPaddingLeft() + 15,
