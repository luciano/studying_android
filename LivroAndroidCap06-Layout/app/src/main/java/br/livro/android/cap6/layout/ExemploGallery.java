 ...
 *
 * Gallery: é capaz de organizar outros componentes lado a lado na horizontal
 * A classe Toast foi usada para exibir um alerta na tela. Que é desenhado
 * pela ImageView selecionada.
 */
...
public class ExemploGallery extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		// É deprecated, mas continua sendo um componente bom. O Google pede pra utilizar o novo ViewPager da compat library.
