...
/**
 * Exemplo de Gallery + ImageSwitcher
 * 
 * @author ricardo
 *
 * Estudado em 26 de Março de 2015
 *
 * ImageSwitcher: Usado para exibir galerias, pode monitorar quando uma imagem é selecionada e criar
 * um efeito especial para alterar de uma imagem para outra.
 * Para o ImageSwitcher é necessario chamar o metodo setFactory(fabrica) informando uma
 * implementacao de android.widget.ViewSwitcher.ViewFactory. Essa interface define o metodo
 * makeView() que retorna uma View.
 */
