...
public class Menu extends ListActivity {
	private static final String[] nomes = new String[] {
			...
			"Exemplo 5 - Abrir receiver do projeto LivroAndroidCap09-BroadcastReceiverStart",
			"Exemplo 6 - Abrir receiver do projeto LivroAndroidCap11-DownloadImagem"
			};
	
	// Receiver registrado dinamicamente
	private ExemploReceiver2 receiver;
	...
	public void onCreate(Bundle icicle) {
		...
		registerReceiver(receiver=new ExemploReceiver2(), new IntentFilter("ABRIR_RECEIVER_2"));
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		switch (position) {
			...
			case 4:
				...
				break;
			case 5:
				//Outro projeto LivroAndroidCap11-DownloadImagem
				sendBroadcast(new Intent("DOWNLOAD_IMAGEM"));
				break;
			default:
				finish();
		}
