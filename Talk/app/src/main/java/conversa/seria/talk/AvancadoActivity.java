...
public class AvancadoActivity extends Arquivo {
...
/*
        ...
        String[] l = TextUtils.split(leitura("avancado"), "\n");
...
*/
    ...
    public void addConteudo(View v) {
        startActivity(new Intent(this, AddActivity.class).putExtra("tabela", "avancado"));
    }
